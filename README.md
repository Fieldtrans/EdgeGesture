...
4. LSPosed 增强使用：在 LSPosed 中启用 EdgeGesture，并勾选带推荐标记的 Android 系统/框架作用域。
...
4. For LSPosed enhanced use, enable EdgeGesture in LSPosed and select the recommended Android system/framework scope.
